      ...
      <div className="wbDesign flex flex-wrap justify-center gap-10 mt-10">
        ...
        <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
          <div className="p-4">
            ...
            ensure that your brand’s message resonates with the right
        ...
        <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
          <div className="p-4">
            ...
            <p className="text-gray-600 mt-2">
            Our targeted campaigns are designed to ensure that your
            message reaches the right audience at the perfect time,
            maximizing its impact and relevance.Our campaigns are
            continuously refined through A/B testing and performance
            tracking to ensure they are always performing at their best.
            </p>
          </div>
        </div>
      </div>

        ...
        <div className="wbDesign flex flex-wrap justify-center gap-10 mt-10">
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              challenges and goals, creating a personalized strategy that’s
              perfectly aligned with your vision. we build a roadmap that
              drives real results and ensures your business stands out in
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              decisions that drive real, measurable results. Every strategy
              is based on solid data, ensuring that each move we make is
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              ensuring that your website not only ranks higher but stays
              there for the long run. With white-hat techniques, we create a
              strong foundation for your business, that protect your brand’s

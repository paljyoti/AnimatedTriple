        ...
        <div className="font-serif">
          <div className="top pt-16">
            ...
            <p className="pt-5 text-base md:text-lg">
              Email marketing remains one of the most effective ways to connect
              with your audience and drive results. At Triple R Consulting, we
              create personalized, impactful email campaigns that help you
              nurture relationships, boost engagement, and grow your business.
            </p>
          </div>
          ...
          <div className="choose flex flex-wrap gap-10 pt-10 font-serif">
            <div className="chooseUs flex-1">
              ...
              <ul className="list-disc pl-5 space-y-3 text-sm md:text-base">
                <li>
                  Personalized Campaigns: We craft tailored messages that speak
                  directly to your audience’s needs and preferences.
                </li>
                <li>
                  Proven Strategies: With a focus on conversions, we design
                  emails that capture attention and drive action.
                </li>
                <li>
                  Advanced Automation: Save time and maximize efficiency with
                  automated email workflows.
                </li>
                <li>
                  Data-Driven Insights: We analyze campaign performance to
                  optimize results and ensure your ROI grows.
                </li>
              </ul>
            </div>
            ...
            <div className="who flex-1">
              ...
              <ul className="list-disc pl-5 space-y-3 text-sm md:text-base">
                <li>
                  Campaign Strategy: End-to-end planning for targeted, effective
                  email marketing.
                </li>
                <li>
                  Email Design & Content: Visually appealing designs and
                  persuasive copy that drives engagement.
                </li>
                <li>
                  Segmentation & Personalization: Reach the right people with
                  the right message at the right time.
                </li>
                <li>
                  Automation Workflows: Welcome emails, drip campaigns,
          ...
          <p className="text-base md:text-lg">
            Whether you’re launching a new product, re-engaging lapsed
            customers, or building loyalty, Triple R Consulting has the
            expertise to create email campaigns that deliver results. Let’s help
            you turn email into one of your most powerful marketing channels.
          </p>
          ...
          <p className="pb-10 text-base md:text-lg">
            Contact us to discuss how we can help you unlock the full potential
            of email marketing.
          </p>
        </div>
      </div>

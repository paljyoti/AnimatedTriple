    ...
    <div className="bg-[#EEF7FF]">
      ...
      <div className="px-5 md:px-28">
        ...
        <h1 className="font-bold text-lg pt-4 md:text-2xl text-justify">
          At Triple R Consulting, we believe that your website is more than just
          an online presence—it’s the cornerstone of your digital identity. A
          well-designed website can elevate your brand, engage your audience,
        ...
        <div className="wbDesign flex flex-wrap justify-center gap-10 mt-10">
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              <p className="text-gray-600 mt-2">
                We believe every business has its own identity,and your website
                should reflect that uniqueness.Our team works closely with you
                to craft custom designs that not only align with your brand’s
                personality but we ensure your website stands out and
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              <p className="text-gray-600 mt-2">
                ...
                flawlessly on any device, ensuring your users have a consistent
                experience.
              </p>
            </div>
          </div>
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              <h3 className="text-xl font-semibold">Edge Technology:</h3>
              <p className="text-gray-600 mt-2">

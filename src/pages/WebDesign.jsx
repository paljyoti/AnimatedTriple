    ...
    <div>
      ...
      <div className="px-5 md:px-28">
        ...
        <div className="top pt-16">
          ...
          <h1 className="font-bold text-2xl pt-4 md:text-3xl text-justify">
        ...
        <div className="para  font-serif">
          ...
          <ul>
            ...
            <li>
              ...
              technologies, we deliver fast, secure, and future-proof websites.
            </li>
            <li>
              4. SEO-Optimized: Our designs are optimized to enhance visibility
              and improve your rankings on search engines.
            </li>
          </ul>
        </div>
        <div className="process font-serif">
          <h4 className="pt-5 font-semibold text-2xl md:text-3xl text-[#39FF14]">
          ...
          <ul>
            ...
            <li>
              2. Design & Development: Our team of experts brings your vision to
            ...
            <li>
              4. Launch & Support: Once live, we provide ongoing support to keep

          ...
          <div className="px-5 md:px-28">
            <div className="font-serif">
              <div className="top pt-16">
                <h6 className="font-bold text-3xl text-[#39FF14]">Content Marketing Services</h6>
                <p className="pt-5 text-base md:text-lg">
                  In a world where content is king, delivering the right message at the right time can set your brand apart. At Triple R Consulting, we craft compelling, value-driven content that attracts, engages, and converts your audience into loyal customers.
                </p>
              </div>

              <div className="choose flex flex-wrap pt-10 gap-10 font-serif">
                <div className="chooseUs flex-1">
                  <h1 className="text-bg font-bold text-3xl">Why Choose Our Content Marketing Services?</h1>
                  <ul className="list-disc pl-5 space-y-3 text-sm md:text-base">
                    <li>Strategic Storytelling: We tell your brand’s story in a way that resonates with your audience and builds trust.</li>
                    <li>Audience-Centric Approach: Every piece of content is designed to address your customers’ needs, pain points, and aspirations.</li>
                    <li>SEO-Optimized Content: Drive organic traffic with content that ranks high on search engines.</li>
                    <li>Multi-Channel Expertise: Whether blogs, videos, or infographics, we create content that works across platforms.</li>
                  </ul>
                </div>
                ...
                <div className="who flex-1">
                  ...
                  <ul className="list-disc pl-5 space-y-3 text-sm md:text-base">
                    <li>Content Strategy Development: A roadmap to ensure your content aligns with your business goals.</li>
                    <li>Blog Writing: Informative and engaging blog posts that establish your brand as an industry thought leader.</li>
                    <li>Video Content: High-quality videos that captivate your audience and boost conversions.</li>
                    <li>Infographics & Visual Content: Eye-catching visuals to simplify complex ideas and drive engagement.</li>
                  </ul>
                </div>
              </div>

              <h6 className="text-bg font-bold text-3xl pt-5">Content That Delivers Results</h6>
              <p className="text-base md:text-lg">
                At Triple R Consulting, we don’t just create content—we create opportunities for your brand to connect, engage, and grow. Whether you’re looking to educate, entertain, or inspire, our content marketing services can help you achieve your goals.
              </p>

              <h6 className="text-bg font-bold text-3xl pt-5">Ready to Make an Impact?</h6>
              <p className="pb-10 text-base md:text-lg">
                Contact us today to explore how our content marketing strategies can take your brand to the next level.
              </p>
            </div>
          </div>

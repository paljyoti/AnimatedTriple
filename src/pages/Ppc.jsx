          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              <p className="text-gray-600 mt-2">
                ...
                reaches the right people at the right time. This highly targeted
                approach maximizes engagement, boosts conversions, and ensures
                every dollar spent on advertising works harder for your brand.
              </p>
            </div>
          </div>
          ...
          <div className="group w-64 h-80 bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="p-4">
              ...
              <p className="text-gray-600 mt-2">
                ...
                analysis, we leverage data at every step to refine and optimize
                your campaigns. By understanding what works and what doesn’t, we
                make informed decisions that drive higher engagement, better

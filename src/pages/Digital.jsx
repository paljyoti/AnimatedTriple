...
import imageWeb1 from "../../src/assets/439.jpg";
  ...
  return (
    <div>
      ...
      <div className="top pt-16">
        ...
        <h4 className="pt-5 font-semibold text-2xl md:text-3xl text-[#39FF14]">Digital Marketing</h4>
        <img src={imageWeb1} alt="Web Design" className="h-auto w-full pt-10" />
      </div>

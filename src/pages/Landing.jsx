...
import image1 from "../../src/assets/people-5579977_1280.png";
  ...
  return (
    <div className="snap-y snap-mandatory overflow-y-auto h-screen scroll-smooth">
      <div className="flex-shrink-0 snap-start w-full h-screen bg-white  items-center justify-center">
        <div className="top flex pl-48 gap-20 mt-3">
        ...
        <div className="container flex mx-auto  space-x-24 p-4 mt-24">
          <div className="text-left mb-6 pl-16">
            <p className="text-black text-sm w-96 pt-16">
          ...
          <div className="text-right">
            <p className="text-black w-96 text-sm pt-16">
      ...
      <div className="flex-shrink-0 snap-start w-full h-screen bg-blue-400 flex items-center justify-center">
        <div className="snap-start">
          <div className="top flex pl-5 gap-10">
            ...
            <div className=" text-black text-justify mt-28 pr-20">
      ...
      <div className="flex-shrink-0 snap-start w-full h-screen bg-yellow-400 items-center justify-center">
        <div className="head text-black text-center ">
        ...
        <div className="footer text-black">
          <div className="container mx-auto flex flex-wrap justify-between">
            <div className=" w-full sm:w-1/3 ">
              <h6 className="text-lg pt-52 pl-6 font-semibold text-left">
                Explore more
              </h6>
            ...
            <div className="contact w-full sm:w-1/3  pr-6">
              <h6 className="text-lg pt-52 font-semibold  text-right">
                Get in touch
              </h6>

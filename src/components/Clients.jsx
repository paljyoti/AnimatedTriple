...
function Clients() {
  return (
    <div className="bg-[#FF8C00] snap-y snap-mandatory  overflow-scroll h-[100vh] w-[100vw] overflow-y-auto touch-auto" >
      <div
        className="top flex pl-52 gap-20  bg-[#FF8C00] snap-start">
